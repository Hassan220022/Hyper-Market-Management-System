...
public class AddProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        categoryIn.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Meat & Seafood", "Canned Goods",
                "Beverages", "Bread & Bakery", "Snacks & Candy", "Dairy & Eggs", "Frozen Foods", "Fruits & Vegetables",
                "Grains, Pasta & Sides", "Paper", "Cleaning Supplies", "Care Products" }));
        ...
        barLayout.setHorizontalGroup(
                barLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, barLayout.createSequentialGroup()
                                ...
                                .addComponent(close1, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
        ...
        addPanelLayout.setHorizontalGroup(
                addPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(bar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                                Short.MAX_VALUE)
                        .addGroup(addPanelLayout.createSequentialGroup()
                                .addContainerGap()
                                .addGroup(addPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, addPanelLayout
                                                .createSequentialGroup()
                                                .addGroup(addPanelLayout
                                ...
                                .addGroup(addPanelLayout
                                        ...
                                        .addGroup(addPanelLayout.createSequentialGroup()
                                                .addGroup(addPanelLayout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING,
                                                                false)
                                                        .addComponent(priceIn, javax.swing.GroupLayout.DEFAULT_SIZE, 66,
                                                                Short.MAX_VALUE)
                                ...
                                .addGroup(addPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(addPanelLayout.createSequentialGroup()
                                                .addGroup(addPanelLayout
                                                        ...
                                                        .addComponent(nameIn, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(jLabel1))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void getDataFromUser() {
        ...
        pdate = LocalDate
                .parse(pyear.getText() + '-' + correctDate(pmonth.getText()) + '-' + correctDate(pday.getText()));
        edate = LocalDate
                .parse(eyear.getText() + '-' + correctDate(emonth.getText()) + '-' + correctDate(eday.getText()));
        ...
        if (quantity <= shortage)
            JOptionPane.showMessageDialog(null, "The quantity is below the specified range(" + shortage + ")",
