...
public class MarketingFrame extends javax.swing.JFrame {
        ...
        private void initComponents() {
                ...
                year_combo.setModel(new javax.swing.DefaultComboBoxModel<>(
                ...
                month_combo.setModel(new javax.swing.DefaultComboBoxModel<>(
                                new String[] { "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11",
                                                "12" }));

                day_combo.setModel(new javax.swing.DefaultComboBoxModel<>(
        ...
        public static void main(String args[]) {
                ...
                try {
                        ...
                        java.util.logging.Logger.getLogger(MarketingFrame.class.getName()).log(
        ...
        public void makeOffer() {
                String offerInput = (String) JOptionPane.showInputDialog(null, "Enter Offer", "Offer",
                ...
                if (offerInput.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Offer cannot be empty", "Invalid Offer",
                ...
                double offerValue;
                try {
                        offerValue = Double.parseDouble(offerInput);
                } catch (NumberFormatException e) {
                        JOptionPane.showMessageDialog(null, "Invalid offer value", "Invalid Offer",
                                        JOptionPane.ERROR_MESSAGE);
                        return;
                }

                LocalDate offerExpiryDate = LocalDate.of(year_combo.getSelectedIndex() + 2021,
                                month_combo.getSelectedIndex() + 1, day_combo.getSelectedIndex() + 1);

                DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
                String dateString = offerExpiryDate.format(formatter);

                int result = m.makeOffer(txt_searchName.getText(), offerValue, dateString);

                if (result == 1) {
                        double originalPrice = Double.parseDouble(txt_price.getText());
                        double discountedPrice = originalPrice * (100 - offerValue) / 100;
                        txt_offer.setText(String.valueOf(offerValue));
                        txt_price.setText(String.valueOf(discountedPrice));
                        JOptionPane.showMessageDialog(null, "Offer made successfully", "Success",
                                        JOptionPane.INFORMATION_MESSAGE);
                } else if (result == -1) {
                        JOptionPane.showMessageDialog(null, "This product already has a current offer", "Offer Error",
                                        JOptionPane.ERROR_MESSAGE);
                } else {
                        JOptionPane.showMessageDialog(null, "Error making offer", "Offer Error",
                                        JOptionPane.ERROR_MESSAGE);
                }
        }
